...
CXXFLAGS = -std=c++11 -Wno-deprecated -fopenmp -msse3 -msse4.1 -msse4.2 -mavx -mavx2 -m64
#CFLAGS = -std=c99 -openmp -m64 -xHOST -ip -ansi-alias -fno-alias -vec-report3
#CXXFLAGS = -std=c++11 -Wno-deprecated -openmp -m64 -xHOST -ip -ansi-alias -fno-alias -vec-report3
CFLAGS += -D_SSE2
CXXFLAGS += -DHAVE_MKL
LINK += -fopenmp
CXXFLAGS += -DDEBUG
